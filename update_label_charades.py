...
if __name__ == "__main__":
    ...
    seed_path = './data/{}_B{}_RE{}/train.json'.format(task, P, 0)
    new_path = './data/{}_B{}_THRESOLD{}_RE{}/train.json'.format(task, P, THRESOLD, I)

    if I == 1:
        old_path = './data/{}_B{}_RE{}/train.json'.format(task, P, I-1)
        logist_path = "./results/{}/B{}_RE{}.pkl".format(task, P, I-1)
    else:
        old_path = './data/{}_B{}_THRESOLD{}_RE{}/train.json'.format(task, P, THRESOLD, I-1)
        logist_path = "./results/{}/B{}_THRESOLD{}_RE{}.pkl".format(task, P, THRESOLD, I-1)
