...
task, P, IOU,  max_len = "charades", 20, 20, 128
# task, IOU, P, max_len = "anet",    20, 30, 100
# task, IOU, P, max_len = "tacos", 15, 30, 256
...
for I in range(0, 10):
    if I == 0:
        SUFFIX = "B{}_RE{}".format(P, I)
    else: 
        SUFFIX = "B{}_THRESOLD{}_RE{}".format(P, IOU, I)
